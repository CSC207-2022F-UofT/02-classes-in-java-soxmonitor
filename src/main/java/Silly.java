...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes two strings as arguments. The name of the Silly
     * instance is their concatenation.
     *
     * @param prefix the string at the start of the concatenation
     * @param suffix the string at the end of the concatenation
     */
    public Silly(String prefix, String suffix) {
